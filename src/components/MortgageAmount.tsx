  ...
  return (
    <div className="mt-6">
      ...
      <div className=" flex w-full h-10 bg-white border-grey border-2 rounded-md border-opacity-75">
        <div className="flex bg-blue-light h-full w-1/6 rounded-md items-center justify-center text-blue text-[16px] opacity-80 font-semibold ">
          ZAR
        </div>
        <input
          value={amount !== null ? amount : ""}
          onChange={handleChange}
          className="bg-white w-full p-4 text-blue rounded-tr-md rounded-br-md text-[16px] font-semibold outline-none"
        />
      </div>
    </div>
  );
